...
function  CalcImei15(si: string; var i15: char ):boolean;
...
//
procedure StartCalc5121mkeys(xIMEI: string; xESN, MKey: dword);
function StepCalc5121mkeys(CmpBuf :pointer ; var Mkeys: array of dword) : boolean;
//
...
//function StepCalc5121mkeys(var CmpBuf: array of dword; var Mkeys: array of dword) : boolean;
function StepCalc5121mkeys(CmpBuf :pointer ; var Mkeys: array of dword) : boolean;
var
dw :dword;
i,x : dword;
