...
int i2c_pmu_read(short reg, char *data, void (*callback)(void *i2c_msg, int err), short cdata, int len);
int i2c_cam_write(short reg, char *data, void (*callback)(void *i2c_msg, int err));
int i2c_cam_read(short reg, char *val, void (*callback)(void *i2c_msg, int err));
int i2c_write_string(char addr, char * str);
