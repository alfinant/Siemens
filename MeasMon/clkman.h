...
#ifdef   C81
#define    ClkRegClient           ((unsigned(*)(int id, const char *name)) 0xA01CFF54)
#define    ClkUnRegClient         ((unsigned(*)(unsigned client)) 0xA01D02C0)
...
//pattern_SGOLD=D8,16,92,E5,04,10,81,E1,D8,16,82,E5,10,40,BD,E8 -10
//pattern_NSG=88,14,92,E5,04,10,81,E1,88,14,82,E5,10,40,BD,E8 -10
//pattern_ELKA=BC,14,92,E5,04,10,81,E1,BC,14,82,E5,10,40,BD,E8 -10
#define    ClkStateOff            ((void(*)(unsigned mask)) 0xA01D0468)
#endif

#ifdef   S75v52
#define    ClkRegClient           ((unsigned(*)(int id, const char *name)) 0xA01D09AC)
#define    ClkUnRegClient         ((unsigned(*)(unsigned client)) 0xA01D0D18)
...
#ifdef   E71v45
#define    ClkRegClient           ((unsigned(*)(int id, const char *name)) 0xA04D0260)
#define    ClkUnRegClient         ((unsigned(*)(unsigned client)) 0xA04D0658)
#define    ClkSetLevel            ((int(*)(unsigned client,int level))0xA04D6AF0)
...
#ifdef   EL71v45
#define    ClkRegClient           ((unsigned(*)(int id, const char *name)) 0xA04D6628)
#define    ClkUnRegClient         ((unsigned(*)(unsigned client)) 0xA04D6A20)
...
#ifdef  CX70v56   
#define    ClkRegCPUClient        ((unsigned(*)(char *name)) 0xA11675F8)  
#define    ClkUnRegCPUClient      ((unsigned(*)(unsigned client)) 0xA1167784)
#define    ClkRegClient           ((unsigned(*)(char *name, int id)) 0xA1167628)
#define    ClkUnRegClient         ((unsigned(*)(unsigned client)) 0xA11677B0)
...
#ifdef  CX75v25
#define    ClkRegCPUClient        ((unsigned(*)(char *name)) 0xA0A91BF0)
#define    ClkUnRegCPUClient      ((unsigned(*)(unsigned client)) A0A91D7C)
#define    ClkRegClient           ((unsigned(*)(char *name)) 0xA0A91C20)
#define    ClkUnRegClient         ((unsigned(*)(unsigned client)) 0xA0A91DA8)
...
#ifdef  CX72v22
#define    ClkStateOn             ((void(*)(unsigned mask)) 0xA1160108)
#endif
